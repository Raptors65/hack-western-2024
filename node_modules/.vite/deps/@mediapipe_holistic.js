    ...
    (function() {
      ...
      z("Promise", function(a) {
        ...
        b.prototype.l = function() {
          ...
          var h = this, k = false;
          return { resolve: g(this.I), reject: g(this.m) };
        };
        ...
        b.prototype.D = function() {
          ...
          var g = y.CustomEvent, h = y.Event, k = y.dispatchEvent;
          if ("undefined" === typeof k) return true;
          "function" === typeof g ? g = new g("unhandledrejection", { cancelable: true }) : "function" === typeof h ? g = new h("unhandledrejection", { cancelable: true }) : (g = y.document.createEvent("CustomEvent"), g.initCustomEvent("unhandledrejection", false, true, g));
          g.promise = this;
          g.reason = this.j;
          return k(g);
        };
      ...
      var Pa = {};
      var Qa = "function" === typeof Uint8Array.prototype.slice, I = 0, J = 0;
      function Ra(a) {
        var b = 0 > a;
        a = Math.abs(a);
        var c = a >>> 0;
      ...
      function Ta(a) {
        ...
        if (0 === a) 0 < 1 / a ? I = J = 0 : (J = 0, I = 2147483648);
          ...
          a = b ? -a : a;
          if (34028234663852886e22 < a) J = 0, I = (b | 2139095040) >>> 0;
          else if (11754943508222875e-54 > a) a = Math.round(a / Math.pow(2, -149)), J = 0, I = (b | a) >>> 0;
          else {
      ...
      ;
      function mb(a) {
        if ("string" === typeof a) return { buffer: La(a), C: false };
        ...
        if (a.constructor === jb) return { buffer: lb(a) || Oa(), C: true };
      ...
      nb.prototype.s = function() {
        var a = this.i, b = this.h, c = a[b], d = a[b + 1];
        var e = a[b + 2];
        a = a[b + 3];
        pb(this, this.h + 4);
      ...
      function Bb(a, b, c) {
        var d = a.h.j, e = a.h.l(), f = a.h.h + e, g = f - d;
      ...
      function O(a, b) {
        ...
        Object.defineProperties(a, { B: { value: b, configurable: true, writable: true, enumerable: false } });
        return b;
      }
      function Jb(a, b) {
        var c = P(a);
      ...
      function Q(a, b) {
        N ? a[N] = b : void 0 !== a.B ? a.B = b : Object.defineProperties(a, { B: { value: b, configurable: true, writable: true, enumerable: false } });
      }
      function Lb(a) {
        O(a, 1);
        return a;
      ...
      function $b(a, b) {
        var c = R(a.o), d = Xb(a, b, 1, void 0, c), e = P(d);
        if (!(e & 4)) {
      ...
      function cc(a, b, c, d, e) {
        a.h || (a.h = {});
        var f = a.h[c], g = Xb(a, c, 3, void 0, e);
        if (!f) {
          var h = g;
          f = [];
          var k = !!(P(a.o) & 16);
      ...
      function ec(a, b, c, d, e) {
        Sb(a);
        var f = cc(a, c, b, false, false);
        c = null != d ? d : new c();
        a = Xb(a, b, 2, void 0, false);
      ...
      function qc(a, b) {
        ...
        a.R && (d.R = a.R.slice());
        f = !!(P(c) & 16);
        for (var g = e ? c.length - 1 : c.length, h = 0; h < g; h++) pc(a, d, h - a.G, c[h], false, f, b);
        if (e) for (var k in e) pc(a, d, +k, e[k], true, f, b);
        return d;
      }
      function bc(a) {
        if (!R(a.o)) return a;
      ...
      function X(a, b, c) {
        null == a && (a = hc);
        hc = void 0;
        var d = this.constructor.i || 0, e = 0 < d, f = this.constructor.h, g = false;
        if (null == a) {
          a = f ? [f] : [];
          var h = 48;
          var k = true;
      ...
      function sc(a, b, c) {
        if (c) {
          ...
          for (e in c) {
            var f = c[e], g = f.qa;
            g || (d.J = f.wa || f.oa.W, f.ja ? (d.aa = tc(f.ja), g = /* @__PURE__ */ function(h) {
              return function(k, l, m) {
                return h.J(k, l, m, h.aa);
              };
            }(d)) : f.ka ? (d.Z = uc(f.da.P, f.ka), g = /* @__PURE__ */ function(h) {
              return function(k, l, m) {
      ...
      function Pc(a, b, c, d, e) {
        var f = c.U, g = xc(d), h = yc(d).P;
        a[b] = function(k, l, m) {
          return f(k, l, m, h, g, e);
        };
      }
      function Qc(a, b, c, d, e, f, g) {
        var h = c.U, k = wc(d, e, f);
        a[b] = function(l, m, r) {
      ...
      var Z = Y(function(a, b, c) {
        ...
        b = $b(b, c);
        if (null != b && b.length) for (L(a, c, 2), vb(a.h, 4 * b.length), c = 0; c < b.length; c++) {
          var d = a.h;
          Ta(b[c]);
          xb(d);
        }
        ...
        var d = a.h, e = 0, f = a = 0, g = d.i, h = d.h;
        do {
          var k = g[h++];
          e |= (k & 127) << f;
          f += 7;
        ...
        b = S(b, c);
        null != b && null != b && (L(a, c, 0), wb(a.h, b));
      }), Wc = Y(function(a, b, c) {
        ...
        if (eb) {
          var f = a, g;
          (g = db) || (g = db = new TextDecoder("utf-8", { fatal: true }));
          a = e + d;
          ...
          try {
            ...
            if (void 0 === cb) {
              ...
              try {
                g.decode(new Uint8Array([97])), cb = true;
              } catch (p) {
                cb = false;
              }
            }
          ...
          d = h + d;
          e = [];
          for (var k = null, l, m; h < d; ) l = a[h++], 128 > l ? e.push(l) : 224 > l ? h >= d ? ab() : (m = a[h++], 194 > l || 128 !== (m & 192) ? (h--, ab()) : e.push((l & 31) << 6 | m & 63)) : 240 > l ? h >= d - 1 ? ab() : (m = a[h++], 128 !== (m & 192) || 224 === l && 160 > m || 237 === l && 160 <= m || 128 !== ((f = a[h++]) & 192) ? (h--, ab()) : e.push((l & 15) << 12 | (m & 63) << 6 | f & 63)) : 244 >= l ? h >= d - 2 ? ab() : (m = a[h++], 128 !== (m & 192) || 0 !== (l << 28) + (m - 144) >> 30 || 128 !== ((f = a[h++]) & 192) || 128 !== ((g = a[h++]) & 192) ? (h--, ab()) : (l = (l & 7) << 18 | (m & 63) << 12 | (f & 63) << 6 | g & 63, l -= 65536, e.push((l >> 10 & 1023) + 55296, (l & 1023) + 56320))) : ab(), 8192 <= e.length && (k = bb(k, e), e.length = 0);
          h = bb(k, e);
        }
        T(b, c, h);
        return true;
        ...
        return function(b, c) {
          a: {
            ...
            try {
              ...
              e = b.h, e.i = null, e.u = false, e.m = 0, e.j = 0, e.h = 0, e.S = false, b.l = -1, b.i = -1, 100 > Db.length && Db.push(b);
            }
            f = void 0;
          }
          return f;
      ...
      na(pd, X);
      var qd = [pd, 1, Z, 2, Z, 3, Z, 4, Z, 5, Z, 6, Uc], rd = ad(qd);
      ...
      function Fd(a) {
        return dc(a, cd, 1).map(function(b) {
          return { index: fc(b, 1), score: W(b, 2), label: null != S(b, 3) ? gc(S(b, 3), "") : void 0, displayName: null != S(b, 4) ? gc(S(b, 4), "") : void 0 };
        });
      }
      ;
      function Gd(a) {
        return { x: W(a, 1), y: W(a, 2), z: W(a, 3), visibility: null != Zb(a, 4) ? W(a, 4) : void 0 };
      }
      function Hd(a) {
      ...
      function Sd(a) {
        ...
        return D(function(p) {
          switch (p.h) {
            ...
            case 2:
              c = p.i;
              if ("object" === typeof window) return Od("createMediapipeSolutionsWasm", { locateFile: a.locateFile }), Od("createMediapipeSolutionsPackedAssets", { locateFile: a.locateFile }), g = b.filter(function(n) {
            ...
            case 4:
              a.j = new a.i.SolutionWasm(), a.ha = false, p.h = 0;
          }
        });
      }
      function Ud(a) {
        ...
        return D(function(l) {
          ...
          a.D = {};
          if (a.h.listeners) for (f = A(a.h.listeners), g = f.next(); !g.done; g = f.next()) h = g.value, Vd(a, h);
          k = a.l;
          a.l = {};
          a.setOptions(k);
          l.h = 0;
      ...
      x.setOptions = function(a, b) {
        ...
        if (b = b || this.h.options) {
          for (var d = [], e = [], f = {}, g = A(Object.keys(a)), h = g.next(); !h.done; f = { X: f.X, Y: f.Y }, h = g.next()) if (h = h.value, !(h in this.l && this.l[h] === a[h])) {
            this.l[h] = a[h];
            var k = b[h];
            void 0 !== k && (k.onChange && (f.X = k.onChange, f.Y = a[h], d.push(/* @__PURE__ */ function(l) {
              return function() {
                var m;
                return D(function(r) {
        ...
        return D(function(p) {
          switch (p.h) {
            ...
            case 3:
              ...
              f = A(Object.keys(a));
              for (g = f.next(); !g.done; g = f.next()) if (h = g.value, k = c.h.inputs[h]) {
                a: {
                  var n = a[h];
                  switch (k.type) {
                    case "video":
                    ...
                    case "detections":
                      ...
                      for (w = 0; w < n.length; ++w) {
                        t = n[w];
                        var v = q.data, E = v.setBoundingBox, M = w;
                        var K = t.la;
                        var u = new pd();
                        V(u, 1, K.ra);
                        V(u, 2, K.sa);
                        ...
                        if (t.ba) for (v = 0; v < t.ba.length; ++v) E = q.data, M = E.addClassification, K = w, u = t.ba[v], F = new cd(), V(F, 2, u.score), u.index && T(F, 1, u.index), u.label && T(F, 3, u.label), u.displayName && T(F, 4, u.displayName), u = F.l(), M.call(E, K, u);
                      }
                      q = q.data;
                      break a;
                    default:
          ...
          switch (v.h) {
            ...
            case 2:
              ...
              if ("detection_list" === r.type) {
                if (p) {
                  var E = p.getRectList();
                  for (var M = p.getLandmarksList(), K = p.getClassificationsList(), u = [], F = 0; F < E.size(); ++F) {
                    var ba = rd(E.get(F)), $d = W(ba, 1), ae = W(ba, 2), be = W(ba, 3), ce = W(ba, 4), de = W(ba, 5, 0), Ma = void 0;
                    Ma = void 0 === Ma ? 0 : Ma;
                    ba = { la: { ra: $d, sa: ae, height: be, width: ce, rotation: de, pa: gc(S(ba, 6), Ma) }, ea: Hd(M.get(F)), ba: Fd(gd(K.get(F))) };
                    u.push(ba);
                  }
                  E = u;
                } else E = [];
      ...
      function Vd(a, b) {
        ...
        f = a.i.PacketListener.implement({ onResults: function(h) {
      ...
      H("matrixDataToMatrix", function(a) {
        ...
        for (f = 0; f < c; f++) for (var g = 0; g < b; g++) {
...
export default require_holistic();
//# sourceMappingURL=@mediapipe_holistic.js.map
